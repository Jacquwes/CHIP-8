...
{
	const int16_t kMemorySize = 0x1000;
	const int8_t  kRegistersSize = 0x10;
	const int8_t  kStackSize = 0x10;

	const int16_t kFontsetMaxSize = 0x200;
	const int16_t kProgramMaxSize = kMemorySize
		- kFontsetMaxSize;
	const int16_t kScreenSize = 0x40 * 0x20;
